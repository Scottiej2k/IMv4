...
Each character has an **id**, used as the `speaker` value in `chapter.json` and as the key in
`config/voices.json`. The speech profile is binding: if a line doesn't sound like the profile, rewrite
the line.

Ages are given at the start of Season 1.
...
## Franco's house: Via dei Tigli 9
...
### Lucia Bernardi · `lucia` · 60
**Franco's secret girlfriend, then not-so-secret, then fiancée.** Born in Naples, she has lived in
Milan for 35 years. She is divorced, a retired primary-school teacher, and now teaches ballroom and
Latin dance at the Centro civico. She has a grown son, **Gennaro**, in London.

- **Personality:** warm, loud, generous, theatrical and completely unintimidated by Franco. She wins
  Chiara over slowly and with great effort.
- **Speech profile:** expressive and affectionate: *Tesoro!*, *Amore mio!*, *Madonna santa!*,
  *Mamma mia!*, lots of diminutives (*un caffettino*, *un momentino*). She asks questions and
  answers them herself. **No Neapolitan dialect**: her origin shows in food, music and warmth. As a
  former teacher she explains things clearly, which is useful at every level.

---

## Bar Tigli and above: Via dei Tigli 2

### Matteo Ferri · `matteo` · 36
**The dreamer with a coffee machine.** Chiara's younger brother. He owns **Bar Tigli** (coffee,
pastries, aperitivo) and lives in the flat above it with Nadia. He's an Inter fan, to his father's
lifelong disappointment.

- **Personality:** charming, big-hearted, impulsive and always one scheme away from greatness:
  karaoke night, sushi-aperitivo, a TikTok account, bar-delivery by bicycle.
- **Arc:** from someone with ideas to someone who finishes things, becoming a father and eventually
  opening a second bar in Milan.
- **Speech profile:** enthusiastic and fast, with football metaphors (*Siamo in zona Cesarini!*,
  *Palla al centro.*). Catchphrase: *Ho un'idea geniale!* The bar gives the textbook's best ordering
  and small-talk language at A1: *Cosa prendi? Un caffè? Subito!*

### Nadia Benali · `nadia` · 34
**The grounded one.** A pharmacist at the *Farmacia Centrale* of Borgoverde. She was born in Milan to
Moroccan parents (her mother, **Samira**, is a recurring character) and is fully Italian and fully
herself. She is Matteo's partner of six years; they aren't married, which Franco brings up at every
Sunday lunch.

- **Personality:** dry, clever, precise, deeply kind under the irony. She is the only person Franco
  is slightly afraid of.
- **Arc:** pregnancy (S2), motherhood (S3+), and balancing career, family and two cultures,
...
**The quiet boy next to the hedge.** Roberto's son, in the same class as Emma. He plays bass,
skateboards and says little.

- **Personality:** shy, kind, dryly funny once you know him. He is embarrassed by his father as much
  as Emma is by hers, which is their first bond.
- **Speech profile:** few words, understatement (*Carino.*, *Ci sta.*, *Tranquilla.*); music and
  skate vocabulary. He opens up in text messages, which could be a format device for chat logs at B1.
